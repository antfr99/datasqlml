...
# --- Load Others Ratings CSV ---
others_df = pd.read_csv("othersratings1.csv", dtype=str)  # read all as string to avoid parsing issues
others_df.columns = others_df.columns.str.strip()

# --- Keep only relevant columns ---
cols_to_keep = ["Const", "Title", "Directors", "Genres", "IMDb Rating", "Your Rating", "Date Rated"]
