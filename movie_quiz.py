...
if scenario == "Scenario 10 – Feature Hypothesis Testing":
    ...
    if st.session_state['scenario10_result']:
        ...
        if not result['predictions'].empty:
            ...
            st.markdown(f"""
            The predicted ratings change when you modify the selected features because the model learns patterns from my ratings.  
            ...
            **Current features used:** {', '.join(result['selected_features'])}  
            ...
            - **IMDb Rating & Num Votes:** reflect general popularity and consensus quality. My ratings are used as the target variable. They are not included as input features, but rather guide the model to learn my taste and apply it to.
            """)
        else:
        ...
        **Scenario 1: Baseline Model (Numeric Features Only)**
        ...
        - Higher RMSE → predictions deviate more from my ratings.
